...
def EightVars_innerProduct():
    # resList = []
    # dicValueOfw = {"w1" : 0, "w2" : 0, "w3" : 0, "w4" : 0, "w5" : 0, "w6" : 0, "w7" : 0, "w8" : 0}
    ...
    #                                                                resTmpList.append(multiply(dicValueOfx["x4"], dicValueOfw["w4"]))
    #                                                                resTmpList.append(multiply(dicValueOfx["x5"], dicValueOfw["w5"]))
    #                                                                resTmpList.append(multiply(dicValueOfx["x6"], dicValueOfw["w6"]))
    #                                                                resTmpList.append(multiply(dicValueOfx["x7"], dicValueOfw["w7"]))
    #                                                                resTmpList.append(multiply(dicValueOfx["x8"], dicValueOfw["w8"]))
    #                                                                resList.append(sum(resTmpList))
    resList = []
...
def NineVars_innerProduct():
    # resList = []
    # dicValueOfw = {"w1" : 0, "w2" : 0, "w3" : 0, "w4" : 0, "w5" : 0, "w6" : 0, "w7" : 0, "w8" : 0, "w9" : 0}
    ...
    #                                                                        resTmpList.append(multiply(dicValueOfx["x7"], dicValueOfw["w7"]))
    #                                                                        resTmpList.append(multiply(dicValueOfx["x8"], dicValueOfw["w8"]))
    #                                                                        resTmpList.append(multiply(dicValueOfx["x9"], dicValueOfw["w9"]))
    #                                                                        resList.append(sum(resTmpList))
    resList = []
