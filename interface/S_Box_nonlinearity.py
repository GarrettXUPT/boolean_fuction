...
'''
def S_BOX_EightVars_innerProduct(varsNum):
    resList = EightVars_innerProduct()
    if varsNum == 8:
        resList = EightVars_innerProduct()
    elif varsNum == 9:
        resList = NineVars_innerProduct()
    ResultList = []
...
def NinethetaGenerate():
    thetaList = []
    dicValueOftheta = {"w1": 0, "w2": 0, "w3": 0, "w4": 0, "w5": 0, "w6": 0, "w7": 0, "w8": 0, "w9": 0}
    for i1 in range(0, 2):
        for i2 in range(0, 2):
            for i3 in range(0, 2):
                for i4 in range(0, 2):
                            ...
                            for i7 in range(0, 2):
                                for i8 in range(0, 2):
                                    for i9 in range(0, 2):
                                        ...
                                        dicValueOftheta["w7"] = i7
                                        dicValueOftheta["w8"] = i8
                                        dicValueOftheta["w9"] = i9
                                        thetaList.append(list(dicValueOftheta.values()))
    return thetaList

def thetaGenerateSelect(varsNum):
    if varsNum == 8:
        return EightthetaGenerate()
    elif varsNum == 9:
        return NinethetaGenerate()
...
def nonlinearity(varsNum, S_BOX_LIST):
    innerList = S_BOX_EightVars_innerProduct(varsNum)
    truthTableList = S_BOX_TRUTHTABLE(S_BOX_LIST)
    thetaList = thetaGenerateSelect(varsNum)
