...
def ElevenVarsAddMol(dicOfw):
    dicOfValue = {"x1" : 0, "x2" : 0, "x3" : 0, "x4" : 0, "x5" : 0, "x6" : 0, "x7" : 0, "x8" : 0, "x9" : 0, "x10" : 0, "x11" : 0}
    resList = []
    lstOfw = list(dicOfw.values())
    for i1 in range(0, 2):
        for i2 in range(0, 2):
...
def TenVarsAddMol(dicOfw):
    dicOfValue = {"x1" : 0, "x2" : 0, "x3" : 0, "x4" : 0, "x5" : 0, "x6" : 0, "x7" : 0, "x8" : 0, "x9" : 0, "x10" : 0}
    resList = []
    lstOfw = list(dicOfw.values())
    for i1 in range(0, 2):
        for i2 in range(0, 2):
...
def AddmolSelect(varsNum, dicOfa):
    if varsNum == 3:
        ...
        return ElevenVarsAddMol(dicOfa)
...
def ElevenVarsTransparencyCompute(varsNum, truthTable, dicIndexList):
    ResList = []
    dicOfa = {"a1": 0, "a2": 0, "a3": 0, "a4" : 0, "a5" : 0, "a6" : 0, "a7" : 0, "a8" : 0, "a9" : 0, "a10" : 0, "a11" : 0}
    for i1 in range(0, 2):
        for i2 in range(0, 2):
            for i3 in range(0, 2):
                for i4 in range(0, 2):
...
def TenVarsTransparencyCompute(varsNum, truthTable, dicIndexList):
    ResList = []
...
def transparencyCompute(varsNum, truthTable, dicIndexList):
    ...
    if varsNum == 5:
        ...
        return TenVarsTransparencyCompute(varsNum, truthTable, dicIndexList)
    elif varsNum == 11:
        return ElevenVarsTransparencyCompute(varsNum, truthTable, dicIndexList)
